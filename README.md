...
### 🔹 Task 6: Executive Summary & Business Recommendations
...
🔗 https://drive.google.com/drive/folders/1ClDDKEcj_BcWUCWBQBKtC2diZqoinLBR
...
- Brand performance:
  - **Solex** – Highest sales
  - **WeareA2B**, **Giant Bicycles** – Strong performance
  - **Norco Bicycles** – Lowest sales
...
- Highest CLV State:
  - New South Wales
- Gender behavior:
  - Females → High-value periodic purchases
  - Males → Frequent mid-value purchases
